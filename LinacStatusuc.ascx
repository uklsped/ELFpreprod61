...
<%@ Register src="controls/OpsLoguc.ascx" tagname="OpsLoguc" tagprefix="uc6" %>
...
&nbsp;<br />
   ...
   <div>
    ...
    <asp:Button ID="HistoryButton" runat="server" Text="View Operation History" causesvalidation="false" OnClick="HistoryButton_Click" /> &nbsp;
...
<%--                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" >
                    <ContentTemplate>--%>
                    <uc6:OpsLoguc ID="OpsLoguc1" runat="server"/>
<%--                   </ContentTemplate>
                   </asp:UpdatePanel>--%>
                </asp:View>
            </asp:MultiView>
